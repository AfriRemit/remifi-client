  ...
  return (
    <div className="min-h-screen px-6 py-8">
      <div className="max-w-2xl mx-auto bg-secondary rounded-2xl p-6 border border-white/10">
        <h1 className="text-2xl md:text-3xl font-semibold text-primary mb-1">Cable TV</h1>
        <p className="text-secondary mb-6">Pay for your cable or satellite TV subscription.</p>
        ...
        <form onSubmit={onSubmit} className="space-y-4">
          ...
          <div>
            <label className="block text-sm text-secondary mb-2">Smart Card Number</label>
            <input type="text" value={smartCardNumber} onChange={(e)=>setSmartCardNumber(e.target.value)} placeholder="Smart card / Decoder ID" className="w-full px-4 py-3 bg-tertiary rounded-lg text-primary placeholder-secondary focus:outline-none focus:ring-2 focus:ring-accent-green" required />
          </div>
          <div>
            <label className="block text-sm text-secondary mb-2">Package</label>
            <input type="text" value={packageName} onChange={(e)=>setPackageName(e.target.value)} placeholder="e.g. Family, Compact, Premium" className="w-full px-4 py-3 bg-tertiary rounded-lg text-primary placeholder-secondary focus:outline-none focus:ring-2 focus:ring-accent-green" required />
          </div>
          <div>
